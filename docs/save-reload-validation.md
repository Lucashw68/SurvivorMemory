...
Attendu: schéma v6, un bâtiment, deux visites, deux rooms, deux containers
...
la mémoire émotionnelle, v4 `importantMemories`, v5 `vehicleMemories` et v6 la
désignation personnelle des véhicules. Les données partielles sont
